...
#define POINTING_DEVICE_CS_PIN GP1 // SS (CSn)
...
#define SPI_DIVISOR (CPU_CLOCK / 6000000) // rp1040 runs at 133Mhz, SPI at 10Mhz

#define CIRQUE_PINNACLE_CLOCK_SPEED 6000000
