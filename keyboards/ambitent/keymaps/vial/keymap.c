...
#define A_UP A(KC_UP)
#define MS_ENT MT(MOD_LSFT,KC_ENT)
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [0] = LAYOUT(
        ...
        MS_Z,    KC_X,    KC_C,    KC_V,    KC_B,           KC_HOME, KC_PGDN, MS_ENT,  KC_UP,          KC_N,   KC_M,    TD(1),    TD(2),   MS_SLSH,
    ...
    [2] = LAYOUT(       
        ...
        _______, _______, _______, _______, _______,        RGB_M_SW,RGB_M_SN,RGB_M_K, RGB_HUD,        KC_LBRC, KC_RBRC, _______, _______, _______,
        KC_LSFT, KC_CAPS, _______, _______, _______,        RGB_M_X, RGB_M_G, RGB_M_T, RGB_HUI,        _______, KC_APP,  KC_SLSH, _______, _______,
                          _______, _______, RGB_TOG,                 RGB_MOD, RGB_RMOD,QK_BOOT,        _______, _______, _______
    ),              
    [3] = LAYOUT(       
        ...
        KC_LSFT, KC_F11,  KC_PSCR, KC_SCRL, KC_PAUS,        KC_LBRC, _______, _______, _______,        KC_END,  _______, A_UP,    KC_SCLN, KC_QUOT,
...
const rgblight_segment_t PROGMEM my_layer2_layer[] = RGBLIGHT_LAYER_SEGMENTS({0, 18, HSV_BLUE});
const rgblight_segment_t PROGMEM my_layer3_layer[] = RGBLIGHT_LAYER_SEGMENTS({0, 18, HSV_GREEN});
const rgblight_segment_t PROGMEM my_layer4_layer[] = RGBLIGHT_LAYER_SEGMENTS({0, 18, HSV_CYAN});
const rgblight_segment_t PROGMEM my_layer5_layer[] = RGBLIGHT_LAYER_SEGMENTS({0, 18, HSV_ORANGE});
const rgblight_segment_t PROGMEM my_layerCL_layer[] = RGBLIGHT_LAYER_SEGMENTS({0, 18, HSV_YELLOW});
const rgblight_segment_t PROGMEM my_layerNL_layer[] = RGBLIGHT_LAYER_SEGMENTS({0, 18, HSV_MAGENTA});
