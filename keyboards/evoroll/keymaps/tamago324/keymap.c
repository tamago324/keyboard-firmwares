...
enum custom_km_keycodes {
    QWERTY = MY_SAFE_RANGE,
    LOWER,
    RAISE,
    ADJUST,
    JU_SCLN,
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  LSFT_T(KC_Z),   KC_X,    KC_C, ALT_T(KC_V), KC_B,                 KC_N, KC_M,  KC_COMM, KC_DOT,  ALT_T(KC_Q),
                                  LOWER,  LCTL_T(KC_SPACE),         TG_SCRL_V, KC_BTN1, KC_BTN4, SFT_T(KC_ENT), RAISE
  ),
  [_LOWER] = LAYOUT(
